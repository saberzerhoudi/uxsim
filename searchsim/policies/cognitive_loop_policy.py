...
from ..core.types import Action, Observation, Persona
...
- Agent persona: {agent_context.get('persona', {}).get('name', 'Unknown')}
- Intent: {agent_context.get('persona', {}).get('intent', 'Unknown')}

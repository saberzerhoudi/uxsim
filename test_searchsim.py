#!/usr/bin/env python3
"""
Simple test script to verify SearchSim framework functionality
"""
...
# Test the framework
async def test_searchsim():
    print("🧪 Testing SearchSim Framework...")
    
    try:
        # Import the framework
        from searchsim import SimulationConfig, run_simulation
        from searchsim.core.types import Persona
        print("✅ Successfully imported SearchSim")
...
def main():
    print("🔬 SearchSim Framework Test")
    print("=" * 50)
    
    success = asyncio.run(test_searchsim())
    
    print("\n" + "=" * 50)
    if success:
        print("🎉 All tests passed! SearchSim framework is working correctly.")
    else:
